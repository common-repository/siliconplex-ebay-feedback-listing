...
<h1>SP Ebay Feedbacks > Settings</h1>
<div class="wrap">
	<?php settings_errors(); ?>
	<form method="post" action="options.php">
		<?php 
			settings_fields( 'sp_ebay_feedbacks_setting' ); //option_group of setting
			do_settings_sections( 'sp_ebay_feedbacks' ); //page of section
			submit_button();
		?>
	</form>
	<br/>
